...
class BannerVendedor(FloatLayout):
    ...
    def __init__(self, **kwargs):
        ...
        link = f'https://aplicativovendashash-e68d3-default-rtdb.firebaseio.com/.json?orderBy="id_vendedor"&equalTo="{id_vendedor}"'
        requisicao = requests.get(link)
        requisicao_dic = requisicao.json()
        # Retorna um OBJETO DICT e converte para lista, essa lista possui apenas um indice -> um dicionário com os valores
